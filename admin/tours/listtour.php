<div class="content">
        ...
        <div class="artical-content">
            <div class="btn-function">
                <div class="btn_add">
                    <a href="index.php?action=addtour"><input type="submit"  value="+ Tạo tour mới"></a>
                </div>
            ...
            <div class="search-tour">
                <span>Tìm kiếm</span><input type="text" name="" id="">
            </div>
            ...
            <tr class="first-table">
                    ...
                    <th class="title-table lich">Lịch trình</th>
                    
                    <th class="title-table tinhtrang">Tình trạng</th>
                    <th class="title-table" colspan="2">Chức năng</th>
                </tr>
                <?php
                $listtour = loadAll_tours(); //để lấy tất cả các tour từ cơ sở dữ liệu.
                foreach ($listtour as $tour) {
                    extract($tour); //khi nào có key mới extract ra được
                    $editsp = "index.php?action=edittour&id=".$id;
                    $deletesp = "index.php?action=deletetour&id=".$id;
                    $hinhpath ="../uploads/".$image;
                    $statusText = ($status == 1) ? '<span class="active-status">Hoạt động</span>' : '<span class="paused-status">Tạm ngưng</span>';                    
                    ...
                    echo '<tr>
                            ...
                            <td class="title-table mota">
                                <div class="clamp-content">' .$schedule.'</div>
                            </td>
